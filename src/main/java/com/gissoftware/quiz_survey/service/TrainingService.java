...
public class TrainingService {
  ...
  public void uploadAndAssignAsync(TrainingUploadAssignDTO request) {
    ...
    if (request.getUserIds() != null && !request.getUserIds().isEmpty()) {
      ...
      boolean encoded =
          !"video".equalsIgnoreCase(savedMaterial.getType())
      ...
      if (encoded) {
        ...
        log.warn(
            "Skipping SSE push — Bunny encoding not complete for trainingId={}",
            savedMaterial.getId());
      }
    ...
    materialRepo
        ...
        .ifPresent(
            material -> {
              ...
              boolean encoded =
                  !"video".equalsIgnoreCase(material.getType())
              ...
              if (encoded) {
                ...
                log.warn(
                    "Skipping SSE in AssignTraining — Bunny encoding not complete for trainingId={}",
                    trainingId);
              }
  ...
  public TrainingAssignment updateProgress(
      String userId, String trainingId, int progress, String userAgent) {
    ...
    assignment.setPlatform(platform);
